 ...
 */
public class SessionUpdateEntryProcessor implements EntryProcessor<String, MapSession, Boolean>, Offloadable {
	...
	@Override
	public Boolean process(Map.Entry<String, MapSession> entry) {
